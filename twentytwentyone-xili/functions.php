<?php
/**
 * All to define child theme twentytwentyone-xili.
 *
...
add_action( 'wp_enqueue_scripts', 'my_theme_enqueue_styles' );
/**
 * Function twentytwentyone_xili_custom_colors_css [to do].
 *
 * @param    <type> $theme_css     The theme css.
 * @param    <type> $primary_color The primary color.
 * @param    <type> $saturation    The saturation.
 *
 * @return   <type> The xili custom colors css.
 */
 ...
 *
 * @param    html $the_form search form.
 */
...
if ( class_exists( 'xili_language' ) ) { // if temporary disabled !
	...
	/**
	 * Function theme_mod_create_array [to do].
	 */
...
/**
 * Function twentytwentyone_xili_add_widgets [to do].
 */
...
/**
 * Function twentytwentyone_xili_header_image [to do].
 */
...
/**
 * Function twentytwentyone_xilidev_setup_custom_header [to do].
 */
...
/**
 * Function twentytwentyone_xili_default_hue [to do].
 *
 * @param    <type> $value The value.
 *
 * @return   <type> The xili default hue.
 */
